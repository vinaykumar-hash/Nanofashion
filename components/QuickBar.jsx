  ...
  return (
    <div className=' z-50 h-screen absolute flex flex-row justify-center items-center pl-4 top-0 left-0'>
        ...
        <ul className='flex flex-col justify-center items-center gap-4'>
            ...
            <li className='h-8 w-8 hover:scale-105 ' onClick={()=>{setshowArtstyle(!showArtSyle)}} ><img src="https://ogcemddocujgszusyyfy.supabase.co/storage/v1/object/public/generated-images/logos/Mountain.png" alt="" /></li>
        </ul>
        
        </div>
        {Clothes? <SideMenu/>:null}
        {showArtSyle ? <Artstyle/>:null}
    </div>
  )
}
